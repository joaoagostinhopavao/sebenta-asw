...
![O formato geral de uma mensagem HTTP: a primeira linha (diferente para pedido e resposta), seguida dos vários grupos de cabeçalhos, e por fim o corpo.](../assets/images/capitulos/cap01/HTTP_message_request_format.png){#fig-01-http-formato-mensagem width="60%"}
