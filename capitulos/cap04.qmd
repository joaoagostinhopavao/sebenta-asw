...
## HTTP é Sem Estado: o Problema {#sec-04-problema-estado}
...
## Sessões (`HttpSession`) {#sec-04-sessoes-http}
...
## Autenticação Baseada em Sessão {#sec-04-autenticacao-sessao}
...
## O Padrão MVC com *Servlet* e JSP {#sec-04-mvc-jsp}

O [Capítulo 1](cap01.qmd) apresentou o padrão MVC a nível conceptual, e o [Capítulo 3](cap03.qmd) mostrou como uma *Servlet* funciona como Controller. Falta a peça final: a View.

![O modelo geral do MVC, aplicável a qualquer interface (não só Web): o Controller atualiza o Model e a apresentação; a View lê o Model para se apresentar.](../assets/images/capitulos/cap04/Modelo_MVC_Geral.png){#fig-04-mvc-geral width="55%"}

Numa aplicação orientada à apresentação, a *Servlet* recebe o pedido e decide **o quê** mostrar, mas delega a **geração do HTML** propriamente dita a uma *JavaServer Page* (JSP). O Model, por sua vez, é uma classe Java comum (por exemplo, um *DAO*), independente de ambos.
...
## Um Exemplo Simples de JSP {#sec-04-exemplo-jsp}
...
## Ciclo de Vida e Objetos Implícitos {#sec-04-ciclo-vida-jsp}

O ciclo de vida de uma JSP segue o mesmo modelo da *Servlet* em que é convertida (ver [Capítulo 3](cap03.qmd)), com dois pormenores próprios:
...
## *Scopes*: Partilhar Informação Dentro do Servidor {#sec-04-scopes}

Tal como as *Servlets* podem partilhar informação com outros módulos através de atributos (ver [Capítulo 3](cap03.qmd)), esses atributos existem sempre dentro de um determinado âmbito, ou *scope*. Existem quatro classes de *scope*:
...
![Os quatro scopes, do mais lato (Application) ao mais restrito (Page): cada um contém o seguinte, e um scope maior implica mais partilha, mas também mais responsabilidade na sua gestão.](../assets/images/capitulos/cap04/Comparacao_Scopes.png){#fig-04-scopes-comparacao width="60%"}
